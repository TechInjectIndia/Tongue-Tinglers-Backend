        ...
        <div className="bg-white rounded-lg p-6">
            <div className="p-0">
                ...
                <p className="text-[16px] text-left mt-5 text-black leading-7">
                    Thank you for placing your Stock Order with Tongue Tinglers!
                    We’re pleased to confirm that your order has been
                    successfully received and is being processed.
                    <br />
                    <b>Order Details:</b>
                    <ul>
                ...
                <p className="text-[16px] text-left mt-5 text-black leading-7">
                    ...
                    tracking details once your sample kit is on its way.

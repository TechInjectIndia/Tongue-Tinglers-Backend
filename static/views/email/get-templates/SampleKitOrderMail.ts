...
import SampleKitOrder from "../react-templates/SampleKitOrder";

interface IEmail extends IMail<null> {}

export class SampleKitOrderMail extends Mail<null> implements IEmail {
    ...
    getBody(data: any): MailBodyOptions {
        const react = SampleKitOrder(data);
        return {
            html: null,
            react: react,
            text: null,
    ...
    getSubject(): string {
        return "Thank You for Ordering Your Kit!";
    }
}

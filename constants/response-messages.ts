...
export const ERROR_MESSAGE = {
    ...
    EXISTS: "Permissions fetched successfully",
    NOT_EXISTS: "Permissions fetched successfully",
    UPDATED: "Permissions fetched successfully",
};

export const SUCCESS_MESSAGE = {
    LOGGED_IN: "Logged In",
    FETCHED: "Permissions fetched successfully",
    CREATED: "Permissions fetched successfully",
    UPDATED: "Permissions fetched successfully",
    DELETED: "Permissions fetched successfully",
    EXISTS: "Permissions fetched successfully",

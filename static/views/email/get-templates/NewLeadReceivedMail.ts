...
import NewLeadReceived from "../react-templates/NewLeadReceived";

interface IWelcomeMail extends IMail<null> {}

export class NewLeadReceivedMail extends Mail<null> implements IWelcomeMail {
    ...
    getBody(data: any): MailBodyOptions {
        const react = NewLeadReceived(data);
        return {
            html: null,
            react: react,
            text: null,

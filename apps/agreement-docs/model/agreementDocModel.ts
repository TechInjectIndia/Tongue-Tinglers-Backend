...
// AgreementDocModel.belongsTo(UserModel, {as: 'createdByUser', foreignKey: 'createdBy'})
// AgreementDocModel.belongsTo(UserModel, {as: 'updatedByUser', foreignKey: 'updatedBy'})

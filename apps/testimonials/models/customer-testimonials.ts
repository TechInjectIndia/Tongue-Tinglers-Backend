...
import IBaseRepo from '../controllers/controller/ICustomerTestimonialsController';

export class CustomerTestimonialsRepo implements IBaseRepo<TTestimonials, TTestimonialsFiltersFrontend> {
    constructor() { }

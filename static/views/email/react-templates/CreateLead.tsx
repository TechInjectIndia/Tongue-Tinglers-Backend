        ...
        <div className="bg-white rounded-lg p-6">
            <div className="p-0">
                <p className="text-[18px] mt-0 text-center text-[#e38b2a] uppercase font-bold leading-normal">
                    Thank you for taking the <br /> first step toward joining
                    the <br /> Tongue Tinglers Revolution!
                </p>

                <p className="text-[16px] text-left mt-5 text-black leading-7">
                    We’re excited about your interest to be a part of our
                ...
                <p className="text-[16px] text-left mt-5 text-black leading-7">
                    ...
                    to share all the information you need about our franchise
                    opportunities.
                    <br />
                    From investment details to operational support, we’ll guide
                    you through everything to make your journey with Tongue
                    Tinglers seamless and rewarding.
                    <br />
                    <br />

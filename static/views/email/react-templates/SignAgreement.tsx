        ...
        <div className="bg-white rounded-lg p-6">
            <div className="p-0">
                ...
                <p className="text-[16px] text-left mt-5 text-black leading-7">
                    Sign your agreement to start your official journey with
                    Tongue Tinglers.
                    <br />
                    We’ve prepared an agreement that outlines our partnership
                ...
                <p className="text-[16px] text-left mt-5 text-black leading-7">
                    Let’s take our journey forward and set the stage for a
                    successful partnership! We’re excited to have you on board

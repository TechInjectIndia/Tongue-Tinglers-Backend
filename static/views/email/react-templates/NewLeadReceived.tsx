        ...
        <div className="bg-white rounded-lg p-6">
            <div className="p-0">
                ...
                <p className="text-[17px] text-left mt-5 text-black leading-7">
                    ...
                    <br />
                    <ul>
                        <li className="text-[17px] text-left text-black">Lead ID: [Lead ID]</li>
                        <li className="text-[17px] text-left text-black">Name: [Lead Name]</li>
                        <li className="text-[17px] text-left text-black">
                            Contact Number: [Lead Contact Number]
                        </li>
                        <li className="text-[17px] text-left text-black">Date Assigned: [Date]</li>
                    </ul>
                </p>
                ...
                <p className="text-[17px] text-left mt-5 text-black leading-7">
                    Please ensure timely communication with the lead to guide them through the next
                    steps.
                    <br />
                    <br />
                    Warm regards,

...
const PendingLeads = (data: any) => (
    <MailLayout>
        <div className="bg-white rounded-lg p-6">
            <div className="p-0">
                <p className="text-[18px] mt-0 text-center text-[#db3330] uppercase font-bold leading-normal">
                    Action Required on Pending Leads
                </p>

                <p className="text-[16px] text-left mt-5 text-black leading-7">
                    This is a reminder to take action on the following leads,
                    which haven’t been updated in the past two days:
                    <br />
                    <ul>
                ...
                <br />
                <p className="text-[16px] text-left mt-5 text-black leading-7">
                    Please review and update the status of these leads as soon
                    as possible. Timely follow-ups are essential to ensure a
                    smooth process for our prospects.
                    <br />
                    <br />
                    Warm regards,
                    <br />

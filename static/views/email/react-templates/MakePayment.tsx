        ...
        <div className="bg-white rounded-lg p-6">
            <div className="p-0">
                ...
                <p className="text-[17px] text-left mt-5 text-black leading-7">
                    To officially become a Tongue Tinglers franchisee partner, please complete your
                    payment using the secure link.
                </p>
                ...
                <p className="text-[17px] text-left mt-5 text-black leading-7">
                    This final step confirms your partnership and sets everything in motion for an
                    exciting journey ahead.We’re thrilled to have you with us and look forward to

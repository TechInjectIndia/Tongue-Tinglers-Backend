...
export class ItemUnitValidations {
    ...
    static validateUpdate = (req: Request, res: Response, next: NextFunction) => {
        ...
        const { error } = ItemUnitSchema.update.validate(req.body);
    ...
    static validateGetAll = (req: Request, res: Response, next: NextFunction) => {
        ...
        // const result = ItemUnitSchema.createSchema.safeParse(req.body);

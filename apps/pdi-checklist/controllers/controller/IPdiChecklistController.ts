...
interface IPdiChecklistController<T, F extends TListFilters> {
     ...
     */
    findByPk(id: string): Promise<IPdiChecklist | null>;
     ...
     * @returns Promise resolving to the PDI Checklist data or null if not found.
     */
    get(id: string): Promise<IPdiChecklist | null>;
     ...
     */
    update(id: string, payload: TPdiChecklistPayload): Promise<[affectedCount: number, updatedChecklist: IPdiChecklist[]]>;

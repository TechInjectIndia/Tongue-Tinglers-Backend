...
function MailLayout({ children }: any) {
    return (
        <Html lang="en">
            ...
            <Tailwind>
                <Container
                    className="main-container w-[700px] my-4 p-5 bg-gray-100 rounded-lg"
                    style={{
                ...
                >
                    <Section>
                        <div className="text-center px-4 pt-4 mb-0 pb-0">
                            <img
                                src={EMAIL_LOGO_URL}
                                className="w-[180px] mx-auto rounded-lg"
                                alt="TT Logo"
                            />
                        </div>
                        <br />
                        ...
                        <div className="footer mt-2 border-t mb-2">
                            ...
                            <br />
                            <div>
                                <button className="text-[14px] w-full border border-none bg-transparent mt-4 !text-white  text-center pt-2 my-0">
                                    Experience the Tingle of Tradition in every
                                    bite!
                                </button>
                            </div>
                        </div>

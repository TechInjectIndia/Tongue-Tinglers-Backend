...
import PendingLeads from "../react-templates/PendingLeads";

interface IEmail extends IMail<null> {}

export class PendingLeadsMail extends Mail<null> implements IEmail {
    ...
    getSubject(): string {
        return "Alert! Action Required on Pending Leads";
    }
}

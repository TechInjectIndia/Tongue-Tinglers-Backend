...
import {ParseLead, LeadPayload} from '../../interface/lead'
/**
...
interface ILeadController<T, F extends TQueryFilters> {
     ...
     */
    getLeadByStatus(id: number): Promise<ParseLead | null>;
     ...
     * @returns Promise resolving to the lead data.
     */
    get(id: number): Promise<ParseLead | null>;
     ...
     * @returns Promise resolving to the lead data.
     */
    getLeadByAttr(whereName: keyof LeadPayload, whereVal: any, getAttributes: Array<keyof LeadPayload>): Promise<ParseLead | null>;
     ...
     */
    create(payload: TLeadPayload): Promise<LeadPayload>;
     ...
     */
    getLeadStatus(whereName: keyof LeadPayload, whereVal: any, getAttributes: Array<keyof TLeadStatus>): Promise<TLeadStatus | null>;
}

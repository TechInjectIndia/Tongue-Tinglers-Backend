    ...
    <MailLayout>
        <div className="bg-white rounded-lg p-6">
            <div className="p-0">
                ...
                <br />
                <p className="text-[16px] text-left mt-5 text-black leading-7">
                    You’ll soon receive an email with your login details and a
                    link to create your password, granting you access to the
                    Tongue Tinglers Ecosystem.
                    <br />
                    Thank you for joining us – let’s make a flavorful impact
                    together!
                    <br />
                    <br />
                    Warm regards,

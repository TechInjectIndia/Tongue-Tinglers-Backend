...
import IBaseRepo from '../controllers/controller/IFranchiseReviewsController';

export class FranchiseReviewsRepo implements IBaseRepo<TReviews, TReviewsFilters> {
    constructor() { }

...
interface IFranchiseModelsController<T, F extends TQueryFilters> {
    /**
     * List FranchiseModelses for a user with filters.
     * @param user_id - The ID of the user.
     * @param filters - Filtering options for the FranchiseModelses.
     * @returns Promise resolving to a list of FranchiseModelses.
     */
    list(filters: F): Promise<FranchiseModelsList>;
